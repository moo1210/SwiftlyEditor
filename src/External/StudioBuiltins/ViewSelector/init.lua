...
function ViewSelector.init()
	viewSelectorScreenGui = StarterGui:FindFirstChild("ViewSelectorScreenGui")
	if viewSelectorScreenGui then
		viewSelectorScreenGui:Destroy()
		RunService:UnbindFromRenderStep("ViewSelectorAfterCamera")
	end

	viewSelectorScreenGui = script.ViewSelectorScreenGui:Clone()
	viewSelectorScreenGui.Parent = StarterGui
